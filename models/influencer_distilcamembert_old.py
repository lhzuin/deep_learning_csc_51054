...
class InfluencerDistilCamembert(nn.Module):
    def __init__(
        self,
        ...
        self.tok = CamembertTokenizer.from_pretrained(base_model) #AutoTokenizer.from_pretrained(base_model, use_fast=True)
