...
@hydra.main(config_path="../configs", config_name="train_camembert2_v7", version_base="1.1")
def train(cfg):
    set_seed(cfg.seed)
    ...
    if cfg.use_warmup:
        ...
        scheduler = get_cosine_schedule_with_warmup(optimizer, int(total_steps*cfg.warmup_fraction_stage1), total_steps)
    else:
        scheduler = None
    ...
    if cfg.use_warmup:
        ...
        scheduler = get_cosine_schedule_with_warmup(optimizer, int(total_steps*cfg.warmup_fraction_stage2), total_steps)
    else:
        scheduler = None
